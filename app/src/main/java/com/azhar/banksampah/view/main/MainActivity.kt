...
import com.azhar.banksampah.view.banksampah.BankSampahActivity
import com.azhar.banksampah.view.history.RiwayatActivity
import com.azhar.banksampah.view.info.InfoActivity
import com.azhar.banksampah.view.input.InputDataActivity
import com.azhar.banksampah.view.jenis.JenisSampahActivity
import com.azhar.banksampah.view.kategori.KategoriActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setInitLayout() {
        ...
        //aaa
        cvKategoriSampah.setOnClickListener { v: View? ->
            val intent = Intent(this@MainActivity, KategoriActivity::class.java)
            startActivity(intent)
        }
        cvKategoriSampah.setOnClickListener { v: View? ->
            val intent = Intent(this@MainActivity, KategoriActivity::class.java)
        ...
        cvBankSampah.setOnClickListener { v: View? ->
            val intent = Intent(this@MainActivity, BankSampahActivity::class.java)
            startActivity(intent)
        }
    }
